...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.next_button'
        db.add_column(u'createstory_project', 'next_button',
                      self.gf('django.db.models.fields.CharField')(default='next', max_length=40),
                      keep_default=False)


        # Changing field 'Project.name'
        db.alter_column(u'createstory_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):
        # Deleting field 'Project.next_button'
        db.delete_column(u'createstory_project', 'next_button')


        # Changing field 'Project.name'
        db.alter_column(u'createstory_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'createstory.project': {
            ...
            'next_button': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
