...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.color_option'
        db.add_column(u'createstory_node', 'color_option',
                      self.gf('django.db.models.fields.CharField')(default='#000000', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.color_option'
        db.delete_column(u'createstory_node', 'color_option')
