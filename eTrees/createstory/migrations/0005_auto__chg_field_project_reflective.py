...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.reflective'
        db.alter_column(u'createstory_project', 'reflective', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Project.reflective'
        db.alter_column(u'createstory_project', 'reflective', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'createstory.node': {
            ...
            'color_option': ('django.db.models.fields.CharField', [], {'default': "'#000000'", 'max_length': '10'}),
        ...
        u'createstory.project': {
            ...
            'reflective': ('django.db.models.fields.TextField', [], {}),
